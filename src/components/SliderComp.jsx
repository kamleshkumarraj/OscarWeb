...
function SliderComp() {
  ...
  return (
    <section id="section" className='flex items-center gap-[10rem] py-[2rem '>
        <div className='hidden sm:block' id="left-btn"><FaArrowCircleLeft size={'2.4rem'} /></div>
        <div id="cart-section" className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-[6rem] '>
        {
        ...
        <div className='hidden sm:block' id="right-btn"><FaArrowCircleRight size={'2.4rem'} /></div>
      </section>
  )
}
